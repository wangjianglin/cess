...
//            .build();
    ...
    @Override
    public HttpCommunicateResult request(lin.client.http.HttpPackage pack,final ResultFunction result) {
        return request(pack,result,null,defaultParams);
    }

    @Override
    public HttpCommunicateResult request(lin.client.http.HttpPackage pack,final ResultFunction result,final FaultFunction fault) {
        return request(pack,result,fault,defaultParams);
    }

    @Override
    public HttpCommunicateResult request(lin.client.http.HttpPackage pack,final ResultFunction result,final FaultFunction fault, HttpCommunicate.Params params){
//    public HttpCommunicateResult request(final lin.client.http.HttpPackage pack, final ResultListener listener, HttpCommunicate.Params params){
