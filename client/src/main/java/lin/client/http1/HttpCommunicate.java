...
//	}
	...
	public static HttpCommunicateResult request(lin.client.http1.HttpPackage pack, ResultListener listener){
		if(listener != null){
	...
	public static HttpCommunicateResult request(lin.client.http1.HttpPackage pack, ResultFunction result){
		return global.request(pack,result,null);
	}
	
	public static HttpCommunicateResult request(lin.client.http1.HttpPackage pack, final ResultFunction result, final FaultFunction fault){
