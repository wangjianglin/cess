...
//		}
	...
	public HttpCommunicateResult request(lin.client.http1.HttpPackage pack, ResultListener listener){
		if(listener != null){
	...
	public HttpCommunicateResult request(lin.client.http1.HttpPackage pack, ResultFunction result){
		return request(pack,result,null);
	}
	
	private CloseableHttpClient http = HttpClients.createDefault();
	
	public HttpCommunicateResult request(lin.client.http1.HttpPackage pack, final ResultFunction result, final FaultFunction fault){
