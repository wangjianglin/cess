...
import lin.client.http1.annotation.HttpFileInfo;
import lin.client.http1.annotation.HttpPackageMethod;
import lin.client.http1.annotation.HttpPackageReturnType;
import lin.client.http1.annotation.HttpPackageUrl;
import lin.client.http1.annotation.HttpParamName;
