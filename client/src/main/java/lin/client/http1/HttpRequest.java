...
public class HttpRequest {
	...
	private lin.client.http1.HttpPackage pack;
...
//	private static final String HTTP_COMM_PROTOCOL = "__http_comm_protocol__";
	public HttpRequest(HttpCommunicateImpl impl, lin.client.http1.HttpPackage pack, ResultListener listener, HttpCommunicateResult result, HttpClient http){
		this.impl = impl;
		this.pack = pack;
...
//						error.setCause(e.getCause().getMessage());
						error.setMessage(lin.util.Utils.printStackTrace(e));
