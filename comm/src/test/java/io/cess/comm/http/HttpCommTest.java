...
public class HttpCommTest {
	...
	public void testSessionId()throws Exception{
		...
		class TmpResultListener implements ResultListener<Object> {
	...
	public void testComm()throws IOException, URISyntaxException{
		...
		HttpCommunicate.request(pack, (String obj, List<Error> warning)-> {
...
//		dataPackage.setRespType(Dwz.class);
		...
		HttpCommunicate.request(dataPackage, new ResultListener<Object>() {
			@Override
			public void result(Object obj, List<Error> warning) {
