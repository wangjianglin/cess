...
//	public static final String  ErrorCode = "exceptionCode";
	...
	public static final String MEDIA_TYPE_CESS = "application/cess";
	public static final String MEDIA_TYPE_CESS2 = "application/cess2";
	public static final String MEDIA_TYPE_CESS_JSON = "application/cess+json";
	public static final String MEDIA_TYPE_CESS_XML = "application/cess+xml";
	public static final String MEDIA_TYPE_CESS2_JSON = "application/cess2+json";
	public static final String MEDIA_TYPE_CESS2_XML = "application/cess2+xml";
