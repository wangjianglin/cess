...
public class LinEntityManagerFactoryBean extends
	...
	//private final LinDefaultPersistenceUnitManager internalPersistenceUnitManager = new LinDefaultPersistenceUnitManager();
	...
	protected EntityManagerFactory createNativeEntityManagerFactory()
		...
		//persistenceUnitInfo.getProperties().pu
