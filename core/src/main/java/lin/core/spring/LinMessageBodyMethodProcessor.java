 ...
 *
 */
public class LinMessageBodyMethodProcessor implements HandlerMethodArgumentResolver,HandlerMethodReturnValueHandler {

	private LinMessageConverter messageConverter = new LinMessageConverter();
	@Override
	public boolean supportsReturnType(MethodParameter returnType) {
		return (AnnotationUtils.findAnnotation(returnType.getContainingClass(), MessageBody.class) != null ||
				returnType.getMethodAnnotation(MessageBody.class) != null);
	}
