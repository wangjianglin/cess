...
public class LinRequestResponseBodyMethodProcessor extends AbstractMessageConverterMethodArgumentResolver implements HandlerMethodReturnValueHandler {

//	private static final MediaType MEDIA_TYPE_APPLICATION = new MediaType("application");
//	private ResponseBodyAdviceChain adviceChain;
	protected LinRequestResponseBodyMethodProcessor(List<HttpMessageConverter<?>> messageConverters) {
